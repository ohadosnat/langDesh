        ...
        >
          <div className="fixed inset-0 flex flex-col flex-grow items-center justify-center content-center">
            <h2 className="font-medium text-3xl w-full mb-6 text-center">
              {score.correct > score.wrong || score.correct > score.skipped
                ? "Nice Work!"
            ...
            <div>
              ...
              <div className="flex space-x-1">
                ...
                <hr
                  ...
                  style={{
                    flexGrow: `${
                      score.correct.length === 0 ? 0.2 : score.correct.length
                    }`,
                  }}
                />
                <hr
                  ...
                  style={{
                    flexGrow: `${
                      score.skipped.length === 0 ? 0.2 : score.skipped.length
                    }`,
                  }}
                />
              </div>
